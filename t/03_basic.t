...
ok(defined(&potentially_defined), 'T202: Defined potentially_defined via ->potentially_candefined.');
ok(defined(&potentially_can), 'T203: Defined potentially_can via ->potentially_candefined.');
...
BEGIN { $Package::Autoloader::Package::CANDEFINED=1; }
package tseT_cisaB::P3;
use strict;
use Test::Simple;
our @ISA = ('Basic_Test');
use Package::Autoloader sub{eval shift};
BEGIN { $Package::Autoloader::Package::CANDEFINED=0; }
